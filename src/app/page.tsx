          ...
          <div className="w-full relative z-10 text-center px-4 sm:px-6">
            ...
            <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 text-xs sm:text-sm text-gray-500 px-4 sm:px-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Community Driven (India)</span>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="w-full px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12 sm:mb-16">
              ...
              <p className="max-w-[900px] text-gray-600 text-sm sm:text-base md:text-lg lg:text-xl/relaxed px-4 sm:px-0">
                Everything you need to make informed decisions about your electronic devices and contribute to a cleaner, greener India.
              </p>
            </div>
            
            <div className="w-full grid items-start gap-6 sm:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-green-50 to-green-100/50 hover:from-green-100 hover:to-green-200/50">
                ...
                <CardContent className="text-gray-600 space-y-3">
                  <p className="text-sm sm:text-base">Calculate the real environmental footprint of your devices using CPCB and MoEFCC data, and discover the value of recoverable materials in INR (₹).</p>
              ...
              <Card className="group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-blue-50 to-blue-100/50 hover:from-blue-100 hover:to-blue-200/50">
                ...
                <CardContent className="text-gray-600 space-y-3">
                  <p className="text-sm sm:text-base">Get instant, reliable answers to all your e-waste questions with our intelligent chatbot, including Indian e-waste rules and recycling best practices.</p>
              ...
              <Card className="group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-purple-50 to-purple-100/50 hover:from-purple-100 hover:to-purple-200/50 sm:col-span-2 lg:col-span-1">
                ...
                <CardContent className="text-gray-600 space-y-3">
                  <p className="text-sm sm:text-base">Find CPCB-authorised e-waste recycling centres and donation points across India with our interactive map and detailed facility information.</p>
          ...
          <div className="w-full px-4 md:px-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center">
              <div className="space-y-2">
                ...
                <div className="text-green-100 text-sm sm:text-base">Device Types Analysed (India)</div>
              </div>
              <div className="space-y-2">
                <div className="text-3xl sm:text-4xl font-bold">100%</div>
                <div className="text-green-100 text-sm sm:text-base">CPCB/MoEFCC Data Compliant</div>
              </div>
              <div className="space-y-2">
                <div className="text-3xl sm:text-4xl font-bold">∞</div>
                <div className="text-green-100 text-sm sm:text-base">Environmental Impact (India)</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="w-full px-4 md:px-6">
          <div className="flex flex-col items-center justify-center gap-4 text-center">
            ...
            <p className="text-xs sm:text-sm text-gray-600 max-w-md px-4 sm:px-0">
              Making e-waste management sustainable and accessible for everyone in India. 
              Join us in building a greener India, one device at a time.
            </p>
